# Appendix: Interview protocol {#appendix-protocol}

[comment]: <> "LTeX: language=nl"

* Kan jij mij kort in je eigen woorden uitleggen wat je rol binnen de IND is, wat je taken zijn/waren en hoe je de applicaties voor het zoeken naar personen hebt gebruikt?
* Welke informatie heb je nodig voordat je een zoekopdracht kan doen?
  ...
  + Helpt de applicatie jou bij het formuleren van een zoekopdracht? Hoe zou dit volgens jou kunnen gebeuren?
* Kan je mij uitleggen welke velden je invult voor het zoeken naar personen.
  + Zijn er volgens jou bepaalde velden die betere resultaten opleveren?
  + In de zoekvelden kan je soms ook gebruik maken van speciale symbolen zoals een sterretje (* wildcards) waardoor je de zoekopdracht flexibeler kan maken. Maak je hiervan gebruik? Indien ja, voor welke velden wel en welke niet?
...
* Kan je mij uitleggen hoe je de juiste persoon vindt in de lijst van resultaten?
...
* In de lijst van resultaten staat er normaal steeds een match score, weet jij hoe die berekent wordt?
  + Zijn de match scores die worden toegkend aan de resultaten nuttig volgens jou?
  + Hoe zouden deze match scores verbeterd kunnen worden?
* Vindt je de lijst van resultaten betrouwbaar? Hoe kan je dit volgens jou zien?
  + Heb je soms duplicaten in de resultatenlijst gezien? Hoe zie je dit? En waarom denk je dat dit soms voorkomt?
  + Ik heb vernomen dat er soms ook een memo aan personen gehangen wordt voor extra informatie, kan jij uitleggen hoe dit juist gebruikt wordt?
...
* Kan jij mij uitleggen hoe je het verschil vindt of je moet zoeken op een reeds bestaande klant of een nieuwe klant zal moeten aanmaken.
